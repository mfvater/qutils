...
1) Create a new QuPath project, placing the 'classifiers' folder with object_classifiers and density_maps sub-folders into the directory. This allows the software to appropriately find the necessary components to run the workflow. Then load target images into the project.
